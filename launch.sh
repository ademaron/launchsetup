...
aws elb create-lb-cookie-stickiness-policy --load-balancer-name itmo444am --policy-name cookie-sticky-policy --cookie-expiration-period 60
aws elb set-load-balancer-policies-of-listener --load-balancer-name itmo444am --load-balancer-port 80 --policy-names cookie-sticky-policy
